...
//
///**
// * Created by asus2015 on 2016/7/24.
// */
//public class PrinterConnectorLWC  implements Runnable, Lifecycle {
...
//     * 已经创建但还未被使用
//     */
//    private Stack<PrinterProcessorLWC> processors = new Stack<PrinterProcessorLWC>();
//
//    /**
//     * 创建的所有线程
//     */
//    private List<PrinterProcessorLWC> createdProcessor = new LinkedList<PrinterProcessorLWC>();
//
...
//                break;
//            PrinterProcessorLWC processor = newProcessor();
//            recycle(processor);
//        }
//    }
//
...
//                            PrinterProcessorLWC processor = createProcessor();
...
//    }
//
//    private PrinterProcessorLWC newProcessor() {
//
//        PrinterProcessorLWC processor = new PrinterProcessorLWC(curProcessors++);
//        try {
//            processor.start();
...
//    }
//
//    private void recycle(PrinterProcessorLWC processor) {
//
//        processors.push(processor);
//    }
//
//    private PrinterProcessorLWC createProcessor() {
//
...
//        try {
//            PrinterConnectorLWC connector = new PrinterConnectorLWC();
