...
// */
//public class OrderServiceClone {
...
//     * 发送批次订单
//     */
//    public void sendBatchOrder(Printer p,Socket socket) {
//        //获取打印机与他的订单集合
...
//     * @param orders    订单缓存队列
//     */
//    private void doSend(Printer printer, Queue<Order> orders,Socket socket) {
//        
//            //准备新的一个批次
...
//
//            //发送数据
//            send(bulk.getBulkOrderB(), printer,socket);
...
//    }
//
//    private void send(byte[] data, Printer printer,Socket socket) {
//       try {
//           //建立并转化批次数据
...
//    }
//
//    public void handleFailBulk(int printerId, int bulkId, Socket socket) {
//        //获取打印机的已发送批次队列
//        Printer printer = ShareMem.printerIdMap.get(printerId);
//        Queue<BulkOrder> bulks = ShareMem.priSentQueueMap.get(printer);
//
...
//    }
//
//    public void handleFailOrder(int printerId, int bulkId, int index, Socket socket) {
//        //获取打印机的已发送批次队列
//        Printer printer = ShareMem.printerIdMap.get(printerId);
//        Queue<BulkOrder> bulks = ShareMem.priSentQueueMap.get(printer);
//
